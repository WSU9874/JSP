...
import kr.ac.kopo.ctc.kopo00.dao.BoardCItemDaoImpl;

public class BoardCItemServiceImpl implements BoardCItemService {

	private BoardCItemDao boardItemDao;
	@Override
	public Pagination getPagination(int page, int countPerPage) throws ClassNotFoundException, SQLException {
		...
		BoardCItemDaoImpl studentItemDaoImpl = new BoardCItemDaoImpl();
	...
	@Override
	public BoardCItemDao getStudentItemDao() {
		return boardItemDao;
	}

	@Override
	public void setBoardCItemDao(BoardCItemDao studentItemDao) {
